...
//                $message['created']   = $result['created_at'];
        ...
        **/
        ...
        public function createCustomizeMessageOut($recipient, $subject, $content, $type, $providerID='', $scheduledAt = '', $priority = 1, $referenceID = 0,$isHtml) {
            $db         = $this->db;
            $provider   = $this->provider;
            ...
            switch ($eventSection) {
               case 'Dashboard Refresh':
                     ...
                     if($usedTime > 4){
                        ...
                        $this->createMessageOut('10006', $content, $eventSection);
                     }
               ...
               case 'Change Password':
                     ...
                     // $this->createMessageOut('10002', $content, $eventSection);
                  break;
               case 'Edit Profile':
