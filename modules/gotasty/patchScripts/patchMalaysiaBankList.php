<?php  echo "Start\n";
    ...
    $excelFile = "malaysiaBankList.xlsx";
    try {
        ...
        // Log::write(date("Y-m-d H:i:s")." Patch Bank List Process Failed... \n");
        // Log::write(date("Y-m-d H:i:s")." Error Message\t: $e->getMessage() \n\n");
        exit();
    }
    ...
    foreach ($bankNameArray as $bankName) {
        ...
        $bankTC = $function->generateDynamicCode("F");
