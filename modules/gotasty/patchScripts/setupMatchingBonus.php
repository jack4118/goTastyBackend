<?php echo "Start\n";
    ...
    $creditDataAry[] = array(
        ...
        "display" => array("english" => "Gotasty Wallet",
        ...
        "adminDisplay" => array("english" => "Gotasty Wallet - Matching",
                           "chineseSimplified" => "Gotasty Wallet - Matching",
                           "chineseTraditional" => "Gotasty Wallet - Matching",
                           "vietnam" => "Gotasty Wallet - Matching",
                           "malay" => "Gotasty Wallet - Matching",
                           "japanese" => "Gotasty Wallet - Matching",
                           "korean" => "Gotasty Wallet - Matching"),
